...
public class Sgf4jAnnotationProcessor extends AbstractProcessor {
  ...
  public synchronized void init(ProcessingEnvironment processingEnv) {
    ...
    messager.printMessage(Diagnostic.Kind.NOTE, "initialized processor: " + this.getClass().getSimpleName() + "...");
  }
  ...
  public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
    ...
    messager.printMessage(Diagnostic.Kind.NOTE, "Annotation processor " + this.getClass().getSimpleName() + " finished processing.");
    return true;
  }
  ...
  private Sgf4jGenerationRequest extractRequestFromAnnotation(final Sgf4j annotation) {
    return new Sgf4jGenerationRequest(getSmithyFileResourceURL(annotation.astPath()), filer, Arrays.stream(annotation.filters()).toList());
  }
