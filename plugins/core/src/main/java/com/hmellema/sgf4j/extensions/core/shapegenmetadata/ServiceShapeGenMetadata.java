...
public class ServiceShapeGenMetadata extends ShapeGenMetadata {
  private static final EnumSet<ShapeType> SUPPORTED_TYPE = EnumSet.of(ShapeType.SERVICE);

  public ServiceShapeGenMetadata(Shape shape) {
